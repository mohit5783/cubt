...
<title>Manage Degrees</title>
<?PHP 	
	$_SESSION['CurrentMenu']="Configuration Master";
	$_SESSION['CurrentSubMenu']="Degrees";
?>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				<a href="Add-Degrees.php"><div id="AddButton" class="md-trigger" data-modal="modal-13">Add New Degree</div></a>
				<!--  start User-table ............................ -->
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Semsters</a></th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">Semester Length</a></th>
				...
				<tr <?PHP if($altrow){echo "class='alternate-row'";} ?> >
					...
					<td><?=$rs['TotalSemester']?></td>
					<td><?=$rs['SemesterLength']?> Months</td>
